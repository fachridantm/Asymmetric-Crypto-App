...
public class Test {
    ...
    public void readFile(String path, javax.swing.JTextArea textField){
        ...
        BufferedReader br;  //used BufferedReader to set Data to the textField line by line that passed as a parameter.
        String line;
    ...
    // function to encrypt the data that given, with 3 parameters.
    ...
    public void decrypt(String encryptedText, String secretKey,javax.swing.JTextArea plainTextField) throws Exception {
        ...
        byte[] message = Base64.decodeBase64(encryptedText.getBytes(StandardCharsets.UTF_8));
        ...
        plainTextField.setText(new String(plainText, StandardCharsets.UTF_8));
    }

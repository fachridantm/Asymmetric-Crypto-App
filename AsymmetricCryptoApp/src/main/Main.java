...
public class Main extends javax.swing.JFrame {
    ...
    FileHandler th = new FileHandler();
    public Main() {
        initComponents();
    }
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
            ...
            if(response == JFileChooser.APPROVE_OPTION){
                // if user clicks "Ok" then get the absolute path of the file,the textField that we want to set the text and pass it to the function from "FileHandler.java" 
